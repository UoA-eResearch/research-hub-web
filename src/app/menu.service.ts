  ...
  constructor(private breadcrumbService: BreadcrumbService, private location: Location) {
    this.root =
      new MenuItem('', '', '', MenuItemType.Root, null, [
        ...
        new MenuItem('support', this.nameSupport, 'escalator', MenuItemType.Content, ContentTypeIds.Support, null, 'page-elements/483_Pacific_28Sep10_1680x220_BW.jpg', "<p>Specialised, technical, or IT support that can assist your research. Find out who you can speak to, and what services and resources are available from across the University to enable and accelerate your work.</p>"),
        new MenuItem('instrumentsEquipment', this.nameInstrumentsEquipment, 'math-compass', MenuItemType.Content, ContentTypeIds.InstrumentsEquipment, null, 'page-elements/20160126-Engineering-Profile-004_1680x220_BW.jpg', "<p>Large scale and specialist equipment available across the University that can help you answer your research questions or produce creative works.</p>"),
