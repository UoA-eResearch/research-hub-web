  ...
  constructor(private breadcrumbService: BreadcrumbService, private location: Location) {
    this.root =
      new MenuItem('', '', '', MenuItemType.Root, null, [
        ...
        new MenuItem('support', this.nameSupport, 'escalator', MenuItemType.Content, this.contentTypeIdSupport, null, 'page-elements/483_Pacific_28Sep10_1680x220_BW.jpg', "<p>Specialised, technical, or IT support that can assist your research. Find out who you can speak to, and what services and resources are available from across the University to enable and accelerate your work.</p>"),
        new MenuItem('instrumentsEquipment', this.nameInstrumentsEquipment, 'math-compass', MenuItemType.Content, this.contentTypeIdInstrumentsEquipment, null, 'page-elements/20160126-Engineering-Profile-004_1680x220_BW.jpg', "<p>Large scale and specialist equipment available across the University that can help you answer your research questions or produce creative works.</p>"),
        new MenuItem('training', this.nameTraining, 'bike', MenuItemType.Content, this.contentTypeIdTraining, null, 'page-elements/Violin_1680x220_BW.jpg', "<p>Workshops, seminars, or training opportunities where you can upskill in a broad range of areas to learn new techniques or improve your research and expertise.</p>"),
        new MenuItem('software', this.nameSoftware, 'laptop-windows', MenuItemType.Content, this.contentTypeIdSoftware, null, 'page-elements/20130930_UoA_Details_031_1680x220_BW.jpg', "<p>Applications and software services that can help you communicate, collaborate, create, or analyse.</p>"),
        new MenuItem('facilitiesSpaces', this.nameFacilitiesSpaces, 'castle', MenuItemType.Content, this.contentTypeIdFacilitiesSpaces, null, 'page-elements/Business_1680x220_BW.jpg', "<p>Places, locations, or specialised infrastructure you can make use of for your research.</p>"),
        new MenuItem('guides', this.nameGuides, 'book-open-variant', MenuItemType.Content, this.contentTypeIdGuide, null, 'page-elements/1483_UoA_13Oct09_1680x220_BW.jpg', "<p>Find the key resources and support for specialised topics, including best practice and related tools or workflows for a given task or subject area.</p>"),
        ...
        new MenuItem('knowledgeArticle', this.nameKnowledgeArticle, 'file-document', MenuItemType.Content, this.contentTypeIdKnowledgeArticle, null, 'page-elements/58_Arts_20March2010_1680x220_BW.jpg', "<p>Short articles and useful information on a broad range of topics that can help your research and creative endeavours at the University of Auckland.</p>"),
