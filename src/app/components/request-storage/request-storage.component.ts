...
export class RequestStorageComponent
  ...
  public updateOptionsList = ["Extend Storage", "Change Access", "Other"];
  ...
  public units = ["Gigabytes", "Terabytes"];

  public access = ["Full Access", "Read Only"];

  public roleTypes = ["Data Owner", "Data Contact", "Project Owner"];

  constructor(
    private formBuilder: FormBuilder,
    dateAdapter: DateAdapter<NativeDateAdapter>,
    private cerApiService: CerApiService,
  ...
  ngOnInit() {
    this.analyticsService.trackIntegratedService(
      this.title,
      this.location.path()
    );
  ...
  canDeactivate() {
    ...
    const dialogRef = this.dialog.open(ConfirmDialogComponent, {
      data: {
        title: "Leave form?",
        message:
          "Leaving this form will delete all of the information you have filled in.",
      },
    });
